...
function initSettings() {
    ...
    let schema = schemaSource.lookup('org.gnome.shell.extensions.EditCorner', true);
    return new Gio.Settings({settings_schema: schema});
}

const EditCornerSettingsWidget = new GObject.Class({
    Name: 'EditCorner.Prefs.EditCornerSettingsWidget',
    GTypeName: 'EditCornerSettingsWidget',
    Extends: Gtk.Grid,
    ...
    _init : function(params) {
        ...
        let msg = new Gtk.Label({label: '<b>Edit hot corner actions:</b>',
                                 use_markup: true});
...
function buildPrefsWidget() {
    let widget = new EditCornerSettingsWidget();
    widget.show_all();
    return widget;
}
